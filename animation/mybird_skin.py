...
skin = [
    ('brazo der', (120, 180), 'b_wing.png', False, False, 0.5),
    ...
    ('torso', (145, 150), 'b_body.png', True, True, 0.5),
    ('cabeza', (130, 170), 'b_head.png', True, True, 0.5),
    ('brazo izq', (130, 160), 'b_wing.png', False, False, 0.5),
