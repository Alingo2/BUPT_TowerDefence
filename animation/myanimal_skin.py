...
skin = [
    ('brazo izq', (130, 200), 'animal_leg.png', False, False, 0.5),
    # ('antebrazo izq', (10, 10), weapen, False, False, 0.4),
    ('muslo izq', (120, 220), 'animal_leg.png', False, False, 0.5),
    ('brazo der', (120, 220), 'animal_leg.png', False, False, 0.5),
    ('muslo der', (120, 210), 'animal_leg.png', False, False, 0.5),
    # ('pierna izq', (10, 75), 'gil-bota2.png', False, False, 0.5),
    ('torso', (145, 150), 'animal_body.png', True, True, 0.5),
    ('cabeza', (130, 150), 'animal_head.png', True, True, 0.5),
